---
title: "Rate limits"
description: "Learn about QCKL's API rate limits."
---

QCKL's API rate limiting is in conformance with the [IETF standard](https://datatracker.ietf.org/doc/html/draft-ietf-httpapi-ratelimit-headers):
...
QCKL's API is capped at **10 requests per second** per user.
